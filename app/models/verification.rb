class Verification < ApplicationRecord
  COPY_ATTRIBUTES = %w(name last_name patronymic birth_date gender citizenship_country_id document_number reason email)
  ...
  validates :citizenship_country_id, :name, :last_name, :gender, :birth_date, :document_number, :reason, presence: true, on: :create
