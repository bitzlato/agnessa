class VerificationDecorator < ApplicationDecorator
  ...
  def self.table_columns
    %i[preview_image id created_at full_name document_number email country status reason applicant]
  end
  ...
  def external_id
    h.content_tag :code do
      h.hightlight_verification_field object.applicant.external_id
    end
  end
