...
Rails.application.config.sorcery.submodules = %i[remember_me reset_password brute_force_protection]
...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `nil`
  #
  config.cookie_domain = Rails.configuration.application.default_url_options[:host]
