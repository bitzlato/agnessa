...
SimpleForm.setup do |config|
  ...
  config.wrappers :signin_form, tag: 'div', class: 'form-group', error_class: 'form-group-invalid-fake',
                                valid_class: 'form-group-valid-fake' do |b|
    b.use :html5
    b.use :placeholder
  ...
  config.wrappers :horizontal_collection_inline, item_wrapper_class: 'form-check form-check-inline', tag: 'div',
    ...
    b.optional :readonly
    b.use :label, class: 'col-sm-3 form-control-label'
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-12' do |ba|
      ba.use :input, class: 'form-check-input', error_class: 'is-invalid', valid_class: 'is-valid'
      ba.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback d-block' }
      ba.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
    end
